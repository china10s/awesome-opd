...
That's it — student rolls out, teacher scores, KL pulls them together.
Different OPD variants only differ in **who plays the teacher** and
**which divergence D** is used.

This single recipe unifies a fast-growing family of methods. We
organize them by **what plays the role of the teacher**:


| Family                                     | Teacher                                                                                      | Representative Methods                                                              |
| ------------------------------------------ | -------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| **Larger external teacher (white-box)**    | A bigger, frozen LLM with logit access                                                       | GKD, MiniLLM, DistiLLM(-2), DASD, GOLD, G-OPD, Lightning OPD, Fast OPD              |
| **Self-distillation (privileged context)** | Same model, conditioned on demos / feedback / "be concise" / verified trace / longer context | SDFT, SDPO, OPSD, OPCD, OPSDC, OEL, MTP-SD, GATES, OPSDL, SD-Zero, π-Play, Skill-SD |
| **Iterative self-bootstrapping**           | A frozen earlier checkpoint of the same model                                                | SPIN, rStar, rStar-Math, rStar2-Agent                                               |
| **Multi-teacher (MOPD)**                   | Several domain-specialist teachers                                                           | MiMo-V2-Flash, Baichuan-M3, Nemotron Cascade 2, DeepSeek-V4                         |
| **Cross-stage / anti-forgetting**          | A previous-stage policy used as anchor                                                       | OPCSD (GLM-5), HY-MT                                                                |
| **Black-box / outcome-based**              | API-only teacher; signal = score / preference / discriminator                                | GAD, OVD, ORPO-Distill                                                              |
| **Inside-RL hybrids**                      | Teacher acts as reward shaping or trust-region anchor inside GRPO/PPO/DPO                    | AlignDistil, LUFFY, NPO, KEPO, BOND, KDRL, RLAD, RLSD, HDPO, OpenClaw-RL            |
| **Speculative-decoding drafter**           | Verifier / target model scores drafter rollouts                                              | DistillSpec, OSD, EAGLE-3, SpecForge, ReSpec, DVI, CORAL, SpecKD                    |
| **Stability & loss engineering**           | (orthogonal axis — same teacher, smarter divergence)                                         | Veto, EOPD, REOPOLD, StableOPD, Revisiting OPD, SCOPE, TIP                          |
| **Cross-tokenizer / cross-family**         | Teacher uses a different vocabulary                                                          | GOLD (HF H4), DSKDv2, KDFlow                                                        |
| **Multimodal / embodied**                  | Vision / video / audio / robot teachers                                                      | Video-OPD, VLA-OPD, π-Flow, VOLD, Step-Audio-R1, CORD, X-OPD, Uni-OPD               |
| **Privacy-preserving**                     | Frozen public teacher + DP-SGD on student                                                    | DP-OPD                                                                              |


It powers the post-training pipelines of **Qwen3 / Qwen3-Coder /
Qwen3.5-Omni**, **GLM-4.5 / 4.6 / 5**, **DeepSeek-V4**,
**MiMo-V2-Flash**, **Baichuan-M3**, **Nemotron Cascade 2**, **HY-MT**,
**HY-Embodied**, **KAT-Coder-V2**, **Gemma 2 / 3**, **Ministral 3**,
...
Charades / ActivityNet / QVHighlights TimeLens ([R@0.7](mailto:R@0.7)), surpasses
...
**(3.7) gradient decomposition** — \nabla J_{\text{off}} = \nabla J_{\text{on}} - \mathrm{Cov}*{\pi*{\text{ref}}}[w(x;\theta), f(x;\theta)],
...
+17 % [R@0.7](mailto:R@0.7) over GRPO across Charades / ActivityNet / QVHighlights.
[[arXiv:2602.02994]](https://arxiv.org/abs/2602.02994)
...
Sorted by **(Family, Year ↓)**. The `Family` column mirrors the
taxonomy in the intro table — same model can appear in multiple
sections of the document but is listed under exactly one Family below.

| Family | Model | Year | Distillation Recipe | Link |
|--------|-------|------|---------------------|------|
| **Strong-to-Weak / Cross-Stage** | **GLM-5 / GLM-5.1** (744B-A40B MoE) | 2026 | **On-Policy Cross-Stage Distillation (OPCSD)** across Reasoning → Agentic → General RL | [arXiv:2602.15763](https://arxiv.org/abs/2602.15763) |
|  | **Qwen3.5-Omni** | 2026 (Alibaba Qwen) | Cross-modal OPD: text reasoning → audio-input reasoning; Thinker-Talker / Hybrid-Attention MoE; ARIA streaming alignment; 215 audio/AV subtasks SOTA | [arXiv:2604.15804](https://arxiv.org/abs/2604.15804) |
...
|  | **HY-MT 1.5** (1.8B / 7B) | 2025 (Tencent Hunyuan) | RKL strong-to-weak distillation; ~90 % of Gemini-3.0-Pro MT with 1.8B params; WMT25 champion lineage | [arXiv:2512.24092](https://arxiv.org/abs/2512.24092) |
|  | **Qwen3-\*-OPD** (0.6B–14B + 30B-A3B) | 2025 | Strong-to-Weak (off-policy SFT → on-policy RKL) — *the canonical industrial OPD recipe* | [arXiv:2505.09388](https://arxiv.org/abs/2505.09388) |
|  | **Gemma 2** (2B/9B/27B) | 2024 | Token-level KD from a Gemini teacher; among the first models to *name* OPD | [Gemma 2 TR](https://storage.googleapis.com/deepmind-media/gemma/gemma-2-report.pdf) |
| **Multi-Teacher (MOPD)** | **DeepSeek-V4** (V4-Pro 1.6T MoE / V4-Flash 284B) | 2026 (DeepSeek) | **Multi-teacher OPD replaces unified mixed-RL stage**: per-domain SFT + GRPO specialists → unified student with **full-vocabulary RKL** on its own rollouts | [Tech Report](https://huggingface.co/deepseek-ai/DeepSeek-V4-Pro/blob/main/DeepSeek_V4.pdf) |
...
|  | **MiMo-V2-Flash** (309B-A15B MoE) | 2026 (Xiaomi) | Multi-Teacher On-Policy Distillation (MOPD) | [arXiv:2601.02780](https://arxiv.org/abs/2601.02780) |
| **Self-Distillation (OPSD)** | **SD-Zero** (Qwen3-4B-Instruct / Olmo-3-7B-Instruct) | 2026 | Self-Revision converts binary RLVR rewards into dense per-token OPSD signal; ≥10 % gain over base; outperforms RFT/GRPO/SDFT at matched sample budget | [arXiv:2604.12002](https://arxiv.org/abs/2604.12002) |
...
|  | **OPSD-Distilled Reasoner** | 2026 | On-Policy Self-Distillation (single-model with verified-trace privileged context) | [arXiv:2601.18734](https://arxiv.org/abs/2601.18734) |
| **Stability & Loss Engineering** | **SCOPE-R1-Distill-Qwen-1.5B** | 2026 | Dual-path PPL-weighted (correct vs incorrect) OPD | [arXiv:2604.10688](https://arxiv.org/abs/2604.10688) |
...
| **Inside-RL Hybrid** | **KAT-Coder-V2** | 2026 (Kuaishou KwaiKAT) | RL + **step-level** OPD (reasoning-tree alignment); 79.6 % SWE-bench Verified vs Claude Opus 4.6's 80.8 %; Tree-Training 6.2× speedup | [arXiv:2603.27703](https://arxiv.org/abs/2603.27703) |
| **Black-Box** | **GAD-Qwen2.5-14B** | 2025 (Microsoft) | First **black-box OPD** at scale: comparable to GPT-5-Chat on LMSYS without teacher logits | [arXiv:2511.10643](https://arxiv.org/abs/2511.10643) |
| **Multimodal & Embodied** | **HY-Embodied 0.5** (MoT-2B edge) | 2026 (Tencent Hunyuan) | FKL OPD from 32B → MoT-2B for embodied reasoning; downstream VLA for dual-arm Xtrainer robot | [arXiv:2604.07430](https://arxiv.org/abs/2604.07430) |
...
| **Sequence-Level / Distribution-Aligned** | **DASD-4B-Thinking** | 2026 | Distribution-Aligned Sequence Distillation | [arXiv:2601.09088](https://arxiv.org/abs/2601.09088) |
| **Iterative Self-Play** | **Zephyr-7B (SPIN)** | 2024 | Self-play fine-tuning (implicit self-distillation) | [arXiv:2401.01335](https://arxiv.org/abs/2401.01335) |
| **Interpolated / Curriculum** | **TAID-LLM-1.5B / VLM-2B** | 2025 | Temporally Adaptive Interpolated Distillation | [arXiv:2501.16937](https://arxiv.org/abs/2501.16937) |
| **Offline / Resource-Efficient** | **Lightning-OPD-Qwen3-30B-A3B** (MoE) | 2026 (NVIDIA) | First single-node (8×H100) OPD on 30B-MoE; AIME 2024 71.0 % / LCBv5 60.8 % | [arXiv:2604.13010](https://arxiv.org/abs/2604.13010) |
...
| **Privacy-Preserving (DP)** | **DP-OPD-DistilGPT-2** | 2026 | First differentially private OPD; ε=2.0, Yelp PPL 41.68 / BigPatent PPL 30.63 (beats DistilDP) | [arXiv:2604.04461](https://arxiv.org/abs/2604.04461) |
| **Cascade / Pruning + KD** | **Ministral 3** (3B/8B/14B) | 2026 | Cascade Distillation (iterative prune + KD) | [arXiv:2601.08584](https://arxiv.org/abs/2601.08584) |
|  | **Llama-3.1-Minitron** (4B/8B) | 2024 (NVIDIA) | Pruning + KD | NVIDIA TR |
| **Foundational OPD** | **MiniLLM-OPT/Llama** | 2023 (THU / MSRA) | Reverse-KL on-policy KD — *the seminal OPD recipe* | [arXiv:2306.08543](https://arxiv.org/abs/2306.08543) |
| **Off-policy KD baselines** *(for comparison)* | **Kimi K2** (1T-A32B MoE) | 2025–26 | RLVR + rubric-distillation into policy (not strict OPD) | [arXiv:2507.20534](https://arxiv.org/abs/2507.20534) |
|  | **Gemma 3** (1B/4B/12B/27B) | 2025 | KD in pre-training + GKD-style IT post-training (KD-dominant hybrid) | [arXiv:2503.19786](https://arxiv.org/abs/2503.19786) |
|  | **DeepSeek-R1-Distill-\*** | 2025 | Off-policy SFT distillation (the classical baseline) | [arXiv:2501.12948](https://arxiv.org/abs/2501.12948) |
...
the box.
[https://github.com/thinking-machines-lab/tinker-cookbook/tree/main/tinker_cookbook/recipes/distillation](https://github.com/thinking-machines-lab/tinker-cookbook/tree/main/tinker_cookbook/recipes/distillation)
...
[https://github.com/china10s/flash-opd](https://github.com/china10s/flash-opd)
- **OPSD official code** — On-Policy Self-Distillation training scripts.
[https://github.com/siyan-zhao/OPSD](https://github.com/siyan-zhao/OPSD)
...
PPL-weighted training. [https://github.com/machine981/SCOPE](https://github.com/machine981/SCOPE)
...
8×H100 node). [https://github.com/jet-ai-projects/Lightning-OPD](https://github.com/jet-ai-projects/Lightning-OPD)
...
[https://github.com/khademfatemeh/dp_opd](https://github.com/khademfatemeh/dp_opd)
- **MiniLLM (Microsoft LMOps)** — official PyTorch implementation of
reverse-KL on-policy distillation for LLMs.
[https://github.com/microsoft/LMOps/tree/main/minillm](https://github.com/microsoft/LMOps/tree/main/minillm)
- **DistiLLM / DistiLLM-2** — official code.
[https://github.com/jongwooko/distillm](https://github.com/jongwooko/distillm)
- **Speculative KD** (Google Research).
[https://github.com/google-research/google-research/tree/master/speculative_kd](https://github.com/google-research/google-research/tree/master/speculative_kd)
...
Native FKL / RKL / GJSD-β. [https://github.com/huggingface/trl](https://github.com/huggingface/trl)
...
variant. [https://github.com/volcengine/verl](https://github.com/volcengine/verl)
...
Ray + Megatron + vLLM. [https://github.com/NVIDIA-NeMo/RL](https://github.com/NVIDIA-NeMo/RL)
...
[https://github.com/NovaSky-AI/SkyRL](https://github.com/NovaSky-AI/SkyRL)
...
[https://github.com/songmzhang/KDFlow](https://github.com/songmzhang/KDFlow)
...
no native OPD recipe shipped. [https://github.com/OpenRLHF/OpenRLHF](https://github.com/OpenRLHF/OpenRLHF)
- **EasyDistill** (Alibaba) — end-to-end distillation framework covering
both off- and on-policy modes (the latter via custom recipes).
[https://github.com/modelscope/easydistill](https://github.com/modelscope/easydistill)
- **SakanaAI/TAID** — reference implementation of Temporally Adaptive
Interpolated Distillation. [https://github.com/SakanaAI/TAID](https://github.com/SakanaAI/TAID)
...
inference. [https://github.com/sgl-project/SpecForge](https://github.com/sgl-project/SpecForge)
...
[https://github.com/LiuXiaoxuanPKU/OSD](https://github.com/LiuXiaoxuanPKU/OSD)
...
[https://tinker-docs.thinkingmachines.ai/cookbook/recipes/distillation/](https://tinker-docs.thinkingmachines.ai/cookbook/recipes/distillation/)
...
recipe. [https://github.com/thunlp/OPD](https://github.com/thunlp/OPD)
...
1. **Teacher Consistency** (Lightning OPD,
  [arXiv:2604.13010](https://arxiv.org/abs/2604.13010))
...
2. **Pre-flight diagnosis (Rethinking OPD, [arXiv:2604.13016](https://arxiv.org/abs/2604.13016))**
...
3. **SFT cold start + prompt-template alignment** (Rethinking OPD)
...
4. **KL anchor + golden mixture** (StableOPD,
  [arXiv:2604.08527](https://arxiv.org/abs/2604.08527))
...
5. **Local-support reverse-KL** (Revisiting OPD,
  [arXiv:2603.25562](https://arxiv.org/abs/2603.25562))
   ...
   trainer.
6. **Dual-path PPL weighting** (SCOPE,
  [arXiv:2604.10688](https://arxiv.org/abs/2604.10688))
...
7. **Choose Reverse-KL for OOD-heavy problems** (VLA-OPD,
  [arXiv:2603.26666](https://arxiv.org/abs/2603.26666))
...
8. **Token-level entropy guard** (EOPD,
...
9. **Reward / log-ratio clipping** (REOPOLD,
  [arXiv:2603.11137](https://arxiv.org/abs/2603.11137))
...
10. **Match the divergence to the evaluation metric.** *DP-OPD*
  ([arXiv:2604.04461](https://arxiv.org/abs/2604.04461)) shows that
...
11. **Use OPD instead of RL when running under DP-SGD.** Same DP-OPD
